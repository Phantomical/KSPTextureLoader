...
partial class CPUTexture2D
{
    ...
    /// </summary>
    public readonly struct KopernicusPalette8 : ICPUTexture2D, ICompileToTexture, IGetPixels
    {
        ...
        public KopernicusPalette8(LargeNativeArray<byte> data, int width, int height)
        {
            this.data = data;
            this.Width = width;
            this.Height = height;
        ...
        public Texture2D CompileToTexture(bool readable)
        {
            ...
            var handle = job.ScheduleBatch(Width * Height, 4096);
