...
partial class CPUTexture2D
{
    ...
    public readonly struct RGHalf : ICPUTexture2D, IGetPixels
    {
        const int epp = 2;
        ...
        {
            return GetPixels<RGHalf, Half2, GetPixelsJob>(
                in this,
                mipLevel,
                allocator,
        ...
        {
            return GetPixels32<RGHalf, Half2, GetPixels32Job>(
                in this,
                mipLevel,
                allocator,
