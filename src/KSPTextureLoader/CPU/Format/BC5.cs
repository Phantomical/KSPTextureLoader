...
partial class CPUTexture2D
{
    public readonly struct BC5 : ICPUTexture2D, IGetPixels
    {
        ...
        public Color GetPixel(int x, int y, int mipLevel = 0)
        {
            ...
            {
                CPU.BurstForward.Bc5GetPixel(in this, x, y, mipLevel, out Color result);
                return result;
            }
        ...
        internal Color GetPixelCore(int x, int y, int mipLevel)
        {
            ...
            float red = CPU.Block.BC4.DecodePixel(block.red, pixelIndex);
            float green = CPU.Block.BC4.DecodePixel(block.green, pixelIndex);
        ...
        struct GetPixelsJob : IGetPixelsBlockJob
        {
            ...
            public FixedArray16<Color> DecodeBlock(int blockIdx)
            {
                ...
                var r = CPU.Block.BC4.DecodeBlock(block.red);
                var g = CPU.Block.BC4.DecodeBlock(block.green);
