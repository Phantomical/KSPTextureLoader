...
partial class CPUTexture2D
{
    ...
    public readonly struct ARGB4444 : ICPUTexture2D, IGetPixels
    {
        ...
        internal ARGB4444(LargeNativeArray<byte> data, int width, int height, int mipCount)
        {
        ...
        {
            return GetPixels<ARGB4444, ushort, GetPixelsJob>(
                in this,
                mipLevel,
                allocator,
        ...
        {
            return GetPixels32<ARGB4444, ushort, GetPixels32Job>(
                in this,
                mipLevel,
                allocator,
